...
public class PinSpawner : MonoBehaviour
{
    ...
    private void HandlePinTrasnform(InputAction.CallbackContext context)
    {
        if (_currentPin == null) return;
    ...
    private void SetPinTransformFromRaycast(Vector2 touchPosition)
    {
        ...
        if (Physics.Raycast(ray, out hit, _rayDistance, _planeLayerMask))
        {
            ...
            // Pin의 Transform.up을 법선 방향으로 설정 : 핀이 표면에 수직으로 꽂힘
    ...
    private void SubscribeInputActions()
    {
        ...
        _inputAction.UserTouch.TouchPosition.performed += HandlePinTrasnform;
    }
